# 전국 청년정책 종합 평가 시스템 v5
# 전략적 강도: 엔트로피 지수 (정책 분야별 균형성과 다양성)
# 행정적 강도: 자체재원기반_청년_1인당_예산/전체_1인당_예산
...
class YouthPolicyEvaluationSystemV2:
    ...
    def calculate_administrative_intensity(self, region_name):
        ...
        adj_budget_per_youth = youth_policy_budget * finance_autonomy / youth_population
        budget_per_capita = total_budget / total_population
        administrative_intensity = adj_budget_per_youth / budget_per_capita

        # concentration_index = budget_per_youth / budget_per_capita if budget_per_capita > 0 else 0

        # effort_index = concentration_index / finance_autonomy
        ...
        return {
            ...
            "자체재원_기반_청년1인당_정책예산_원": adj_budget_per_youth,
